...
from config.config_mnist import cfg
...
if __name__ == '__main__':
    ...
    # path
    train_dir = os.path.join(BASE_DIR, "..", "data", "mnist_train")
    test_dir = os.path.join(BASE_DIR, "..", "data", "mnist_test")
    ...
    # ------------------------------------ step 1/5 : 加载数据------------------------------------
    # 构建MyDataset实例
    train_data = torchvision.datasets.MNIST(root=train_dir, train=True,
                                        download=True, transform=cfg.transforms_train)
    valid_data = torchvision.datasets.MNIST(root=test_dir, train=False,
